...
function renderDramaList(jsonData) {
    if (jsonData!="")
    {
        ...
        for(i=0 ; i<dramaList.length ; i++)
            newHTMLData += "<div class='item-" + (i+1) + "'><a href='kdramalinesquotes.html?id=" + dramaList[i].dramaid + "' class='card'><div class='thumb' style='background-image: url(" + dramaList[i].image + ");'></div><article><h1>" + dramaList[i].title + "</h1><p>" + dramaList[i].desc + "</p><span>" + dramaList[i].desc2 + "</span></article></a></div>";
